...
public class URestaurantListActivity extends AppCompatActivity {
...
/*
        ...
        customAdapter = new RestaurantApter(URestaurantListActivity.this, dataArrayList);
...
/*
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                final AlertDialog.Builder builder  = new AlertDialog.Builder(URestaurantListActivity.this).setView(v);
