...
public class IngrediantListActivity extends AppCompatActivity {
...
/*
        ...
        ingrediantAdapter = new IngrediantAdapter(IngrediantListActivity.this, dataArrayList);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                final AlertDialog.Builder builder  = new AlertDialog.Builder(IngrediantListActivity.this).setView(v);
