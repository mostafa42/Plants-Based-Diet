...
public class DinnerActivityPlan2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dinner_plan2);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new MealsAdapter(DinnerActivityPlan2.this, arrayOfMeals);
