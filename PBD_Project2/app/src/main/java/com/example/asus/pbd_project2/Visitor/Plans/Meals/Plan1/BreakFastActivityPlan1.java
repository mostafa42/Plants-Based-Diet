...
public class BreakFastActivityPlan1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_break_fast_plan1);
        ...
        listView = (ListView) findViewById(R.id.breakfast_listview);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new MealsAdapter(BreakFastActivityPlan1.this, arrayOfMeals);
