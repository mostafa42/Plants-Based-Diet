...
public class LunchActivityPlan1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lunch_plan1);
        ...
        listView = (ListView) findViewById(R.id.lunch_listview);
            ...
            reference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    adapter = new MealsAdapter(LunchActivityPlan1.this, arrayOfMeals);
        ...
        Toast.makeText(LunchActivityPlan1.this, ""+ex, Toast.LENGTH_LONG).show();
    }
