...
public class UDiseasesListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        diseasesApter = new DiseasesApter(UDiseasesListActivity.this, dataArrayList);
...
/*
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                final AlertDialog.Builder builder  = new AlertDialog.Builder(UDiseasesListActivity.this).setView(v);
