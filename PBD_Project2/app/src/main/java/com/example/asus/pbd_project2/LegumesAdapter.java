...
public class LegumesAdapter extends BaseAdapter {
    ...
    public LegumesAdapter(Context context, ArrayList<IngrediantClass> data) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        view = inflater.from(context).inflate(R.layout.legumes_list,viewGroup,false);
